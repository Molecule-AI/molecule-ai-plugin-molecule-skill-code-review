# Known Issues — molecule-skill-code-review
...
| Level | Description |
|---|---|
| P0 | False negative: real bug not caught |
| P1 | Review crashes or misses entire files |
| P2 | Noise: too many false positives |
...
Use the Molecule-AI/internal issue tracker. Tag with `plugin-molecule-skill-code-review`.
